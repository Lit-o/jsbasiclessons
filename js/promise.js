...
// Promise.all принимает массив промисов и выполняется когда все промисы выполнены
// Promise.race принимает массив промисов и выполняется когда хотя бы один выполнен
